    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-xl border border-border bg-card p-8 shadow-lg">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 rounded-lg bg-[#F0B90B] px-4 py-3 text-base font-bold text-[#0B0E11] hover:bg-[#D4A017] transition-colors duration-150 border-0"
        >
