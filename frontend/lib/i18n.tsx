...
const translations: Record<string, { en: string; zh: string }> = {
  ...
  "sidebar.ranking": { en: "Ranking", zh: "排行榜" },
  "sidebar.leaderboard": { en: "Leaderboard", zh: "排行榜" },
  ...
  "subscription.howDeducted": { en: "Deducted: 0.1 USD gross profit = 1 token, applied daily (e.g. 10:30 UTC). Credits refresh on plan renewal.", zh: "扣除：0.1 美元毛利 = 1 代幣，每日結算（如 10:30 UTC）。方案續訂時額度重置。" },
  ...
  "subscription.faqDeductA": { en: "Each day we deduct tokens equal to your gross profit in USD (0.1 USD = 1 token), e.g. at 10:30 UTC. If you have no profit that day, nothing is deducted.", zh: "每日依您的毛利扣除對應代幣（0.1 美元 = 1 代幣），例如 10:30 UTC。當日無毛利則不扣。" },
