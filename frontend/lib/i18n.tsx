...
const translations: Record<string, { en: string; zh: string }> = {
  ...
  "settings.tokenUsageExplanation": { en: "Token usage is calculated from your gross profit from lending: every 0.1 USD of gross profit counts as 1 token used. Tokens remaining = initial plan credit + purchased tokens − tokens used.", zh: "代幣使用量依您的出借總收益計算：每 0.1 美元總收益計為 1 代幣。剩餘代幣 = 方案初始額度 + 加購代幣 − 已使用代幣。" },
