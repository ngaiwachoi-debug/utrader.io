...
const translations: Record<string, TranslationEntry> = {
  ...
  "dashboard.tokenUsageRule": { en: "1 USD gross profit = 1 token used. Deducted daily.", zh: "1 美元毛利 = 1 代幣使用，每日扣減。" },
  ...
  "subscription.howUseBody": { en: "We deduct 1 token per 1 USD of your daily gross profit from margin funding (e.g. 10:30 UTC). No profit that day = no deduction. View full history in Settings → Token activity.", zh: "每日依您的保證金毛利 1 美元扣 1 代幣（約 10:30 UTC）。當日無收益則不扣。完整記錄請至 設定 → 代幣記錄 查看。" },
  ...
  "subscription.howDeducted": { en: "Deducted: 1 USD gross profit = 1 token, applied daily (e.g. 10:30 UTC). Credits refresh on plan renewal.", zh: "扣除：1 美元毛利 = 1 代幣，每日結算（如 10:30 UTC）。方案續訂時額度重置。" },
  ...
  "subscription.faqDeductA": { en: "Each day we deduct 1 token per 1 USD of your gross profit from margin funding (e.g. at 10:30 UTC). No profit that day means no deduction.", zh: "每日依您的保證金毛利 1 美元扣 1 代幣（例如 10:30 UTC）。當日無收益則不扣。" },
